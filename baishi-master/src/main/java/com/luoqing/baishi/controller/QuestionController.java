...
import com.luoqing.baishi.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionVO>> listQuestionVOBySort() {
        // 假设有序集合的key是 "question:browse"
        String key = "question:browse";
        // 获取有序集合
        RScoredSortedSet<Long> scoredSortedSet = redissonClient.getScoredSortedSet(key);
        // 获取有序集合的元素
        Collection<Long> values = scoredSortedSet.valueRangeReversed(0, 9);
